...
class DeleteButton extends React.Component {
  ...
  render() {
    return (
      <Tooltip title="delete"> { /* for new entry/edit page, this should say discard */}
        <button className="deleteButton journey-button header-button" onClick={() => alert('goodbye, entry ;(')}>
