...
class SubmitSaveButton extends React.Component {
	...
	render() {
		return (
			<Tooltip title="save">
				<button className="submit-save-button header-button journey-button" onClick={() => {this.post(this.refreshText()); alert("Your daily entry has been saved. You can edit this entry until midnight tonight.")}}>
