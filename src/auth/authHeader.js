...
class AuthHeader extends React.Component {
    // simple banner component, just holds big logo
    constructor (props) {
        super(props);
    }
    ...
    render () {
        return (
            <div className="auth-header">
                <center>
                    <svg className="journey-logo journey-logo-auth" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 800 300">
                        <g>
                            <path className="st0" d="M111.8,180.3c0,0,20.6-8.2,32.6-18c2.6,0,4.4,1.8,3.8,4.6c-0.4,2-2.6,4.2-6.6,7.2c-7.4,5.6-20,12.6-31.8,18.4
                            ...
                            <path className="st0" d="M232.5,135.3c0,4.4-0.4,8.6-1,12.6c15-2.2,24.2-15.6,24.2-15.6c2.6,0,4,2,3.6,5c-1.2,7-13.8,17.8-29.8,19.8
                            ...
                            <path className="st0" d="M307.5,165.3c-2.8,5.6-5.8,10.6-9,14.8c-8.4,11.4-17.2,17-28.2,17c-13.4,0-21.8-9.4-21.8-23.2
                            ...
                            <path className="st0" d="M394.1,125.7c12.8-21.6,26.2-28.6,35.2-28.6c9.8,0,16,5.4,16,15.6c0,11.2-6.8,19.2-16.6,19.2
                                ...
                                L394.1,125.7z"/>
                            <path className="st0" d="M516.3,127.3c1.6-9.6-0.4-12.6-4.8-12.6c-12.6,0-31.6,29.8-37.8,63.4c-2.2,12.6-0.2,17.2-0.2,17.2
                                ...
                                L516.3,127.3z"/>
                            <path className="st0" d="M561.1,153.9c0-35.4,27-56.8,53.6-56.8c20.4,0,28.6,10.6,28.6,20.8c0,18.2-21,30.2-56.2,36.8
                            ...
                            <path className="st0" d="M732.3,194.9c-7.8,46.4-26.4,72.2-56,72.2c-13.6,0-22.4-8.6-22.4-21c0-11.8,7-22.6,16.8-31
